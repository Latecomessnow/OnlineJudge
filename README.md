...
本项目整体框架主要由三个模块构成，公共模块、编译并运行模块和OJ服务器模块，项目的整体流程是这样的，用户在浏览器上键入IP地址和端口号访问服务器，点击开始刷题获取题目列表，编写好某一道题之后提交代码，请求OJ服务器的判题功能，由OJ服务器去均衡的调度主机上的编译并运行服务，并将运行结果通过HTTP响应以网页形式回显到网站上。
